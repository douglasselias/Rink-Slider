flags := "-std=c++11 -Wall -Wextra -Wconversion -Wdouble-promotion -Werror=unused-comparison -Wformat=2 -Wpadded -Wshadow -fno-exceptions -fno-rtti -fstrict-aliasing -Wstrict-aliasing=2 -fstack-protector-all -fsanitize=address,undefined -fsanitize-trap=all -O0 -g3 -o"
